...
// ------------------------------------------------------------------
// LoopBreak v5 — a calm companion for post-ABI rumination
...
const SORTS = [
  {
    ...
    caveat: "If part of you thinks it might genuinely still be live, be honest and sort it as a real job or one for a professional instead.",
  },
  {
    key: "job",
    icon: "🔧",
